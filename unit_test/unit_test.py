...
if __name__ == "__main__":
    ...
    # 确保创建trace_unittest文件夹
    job_names = ["_nnTo1n", "_pairwiseTo1n"]
    path = "./trace_unittest{}_{}nodes_{}gpu_per_node/{}".format(\
    ...
    tensor = (local_rank * torch.ones((400380, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2), dtype=torch.cfloat)).to(device)
